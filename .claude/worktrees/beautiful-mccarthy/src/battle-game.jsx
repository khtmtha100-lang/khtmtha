...
export default function BattleGame({ onExit }) {
      ...
      {gameState === 'menu' && (
        <div className="h-full w-full flex flex-col items-center justify-center p-6 text-center">
          <div className="mb-8">
            ...
            <h1 className={`text-5xl font-black mb-2 ${text}`}>تحدي الوحش</h1>
            <p className={`text-lg ${text} opacity-70`}>وضع لانهائي - 10 أرواح 🔥</p>
          </div>
